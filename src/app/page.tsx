       ...
       <ClientOnly>
        <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-3">
             <Link 
              ...
              className="bg-blue-600 text-white h-12 w-12 rounded-full shadow-lg flex items-center justify-center transform transition-transform hover:scale-110 animate-pulse"
              >
        ...
        <div className="fixed bottom-4 left-4 z-50 flex flex-col gap-3">
            <Link 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#25D366] text-white h-12 w-12 rounded-full shadow-lg flex items-center justify-center transform transition-transform hover:scale-110 animate-pulse"
              >
